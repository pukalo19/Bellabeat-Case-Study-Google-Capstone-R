...
_This case study will follow the six step data analysis process:_
###  1. [Ask](#step-1-ask)
...
## Introduction 
Bellabeat is a high-tech company that manufactures health-focused smart products, including fitness trackers and smartwatches. Their products collect data on activity, sleep, stress, and reproductive health, empowering women with knowledge about their own health and habits. Since its founding in 2013, Bellabeat has rapidly grown and positioned itself as a tech-driven wellness company for women. In this case study, we will analyze data from an established competitor to identify growth opportunities and make recommendations for Bellabeat's marketing strategy.

## Step 1: Ask

## Business Task
Analyze the data from a competitor to identify trends in smart device usage and how they can apply to Bellabeat customers. Use these insights to influence Bellabeat's marketing strategy and unlock new growth opportunities.

**Stakeholders:** 

* Urška Sršen: Cheif Creative Officer of bellabeat and Co-founder
* Sando Mur: Co-founder of bellabeat and mathematician

**Guiding questions for analysis**
1. What are the trends in smart device usage based on the competitor's data?
2. How can these trends be applied to Bellabeat customers?
3. How can these trends influence Bellabeat's marketing strategy to drive growth?
...
The data used in this anlysis can be found here:[FitBit Fitness Tracker Data](https://www.kaggle.com/datasets/arashnic/fitbit) CC0: Public Domain, dataset made available through [Mobius](https://www.kaggle.com/arashnic)
 It was generated by respondents to a distributed survey via Amazon Mechanical Turk between 03.12.2016-05.12.2016. The dataset includes minute-level output for physical activity, heart rate, and sleep monitoring. The data was then uploaded and stored into R Studio Cloud.

ROCCC Data Review 
* **Reliability - LOW:** The data comes from a small sample size of Fitbit users who consented to submit their personal tracker data.
* **Original - LOW:** The data was collected through a third-party, Amazon Mechanical Turk.
* **Comprehensive - MED:** The dataset consists of six different fields
* **Current - LOW:** The dataset is from 2016 and may not reflect current user habits.
* **Cited - LOW:** The data was collected from a third party, so its specific source is unknown.
...
```
## Insights:
* Participants averaged 7,638 steps per day, indicating a light activity level
* Sedentary time was high, with an average of 16.5 hours spent sedentary.
* Participants burned an average of 2,304 calories per day.
* Lightly active is what most of our participants would be categorized as.
* Sleep duration averaged around 7 hours, with participants spending an average of 7.6 hours in bed each night.
